...
export function AdminPracticeForm({ practice }: { practice: Practice }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`/api/admin/practices/${practice.id}`, {
        method: "PUT",
        headers: {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-2">
        <Label htmlFor="about_practice">About Practice</Label>
        <Textarea
          id="about_practice"
          name="about_practice"
